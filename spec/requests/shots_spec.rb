...
describe "Api::V1::Shots" do
  context "POST /api/v1/games/:id/shots" do
    ...
    it "updates the message but not the board with invalid coordinates" do
      ...
      player_1= Player.new(Board.new(1), player.api_key)
      player_2 = Player.new(Board.new(1), opponent.api_key)
      game = create(:game, player_1: player_1, player_2: player_2)

      headers = { "CONTENT_TYPE" => "application/json", "X-API-KEY" => player.api_key}
